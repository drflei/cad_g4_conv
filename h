Help on function merge_vertices in module trimesh.base:

mmeerrggee__vveerrttiicceess(self, merge_tex: Optional[bool] = None, merge_norm: Optional[bool] = None, digits_vertex: Union[int, numpy.integer, numpy.unsignedinteger, NoneType] = None, digits_norm: Union[int, numpy.integer, numpy.unsignedinteger, NoneType] = None, digits_uv: Union[int, numpy.integer, numpy.unsignedinteger, NoneType] = None) -> None
